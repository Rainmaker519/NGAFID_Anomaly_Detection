...
class CheckpointSerialVar(object):
    ...
    def __init__(self):
        ...
        self._read_op = tf.convert_to_tensor(value=self._variable)
        self._assign_ph = tf.compat.v1.placeholder(dtype=tf.string, shape=())
        self._assign_op = tf.compat.v1.assign(self._variable, self._assign_ph)
